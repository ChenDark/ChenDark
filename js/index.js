$(function(){
    ...
    var musicImgsData = ['img/fd.jpg','img/bg.jpg','img/bg1.jpg','img/bg2.jpg']    // 图片地址数组
    var musicNameData = ['风笛','出山','盗将行','归去来兮'];                   // 歌曲名数组
    var artistNameData = ['DDBY','花粥/王胜娚','花粥/马雨阳','花粥']            // 创作歌手数组
    var musicUrls=['mp3/DDBY.mp3','mp3/music1.mp3','mp3/music2.mp3','mp3/music3.mp3'];// 歌曲mp3数组
